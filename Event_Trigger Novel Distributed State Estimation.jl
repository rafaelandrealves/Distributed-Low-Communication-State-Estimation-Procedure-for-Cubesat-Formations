...
for i = 2:SizeOfDataSet
    ...
    ############# Filter Processing #############
        ...
        x_new_chief,P_chief,phi_t_chief,aux1_Info_Jk_chief = ChiefFilterEKFFunctionwCRLB(x_pos_old_chief,TruePos_chief,Y_chief[i],P_chief,T,R_chief,Q_chief,aux_Info_Jk_chief,FLAG_GPS);
